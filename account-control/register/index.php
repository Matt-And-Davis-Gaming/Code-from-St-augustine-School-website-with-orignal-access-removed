...
?>
	...
	<div class="container">
		<!--[if lt IE 7]>
	        ...
	        <!--[if !IE]>
				Google Chrome users may experience a slight delay in speed with this form, due to running scripts on the server, encoding before sending, and data transfer rates.
			<![endif]-->
					        <?php
